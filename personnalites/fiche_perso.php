...
<?php
	...
	load_personnalite_biography($perso);
	load_footer();
	load_header_end(); 
	//fin des fonctions
	...
	function load_header()
	{
		...
		{
			if($_SESSION['theme']=="Rouge")
				echo "<link href=\"../styles/personnalites/fiche_personnalite_css.css\" rel=\"stylesheet\" type=\"text/css\"/>";
			else if($_SESSION['theme']=="Bleu")
				echo "<link href=\"../styles/personnalites/fiche_personnalite_css_blue.css\" rel=\"stylesheet\" type=\"text/css\"/>";
			else
				echo "<link href=\"../styles/personnalites/fiche_personnalite_css_green.css\" rel=\"stylesheet\" type=\"text/css\"/>";
		}
		else
			echo "<link href=\"../styles/personnalites/fiche_personnalite_css.css\" rel=\"stylesheet\" type=\"text/css\"/>";
	}
	...
	//même fonctionnement que pour une fiche de série
	//poster en fond, affichage des informations formatées de l'individu
	...
	function load_personnalite_nav_menu($perso)
	{
		$string="<div id=\"personnalite_nav_menu\">
					<div class=\"menu_tab\">
						<p><a href=\"fiche_perso_filmographie.php?nom=".$perso->getLname()."&prenom=".$perso->getFname()."\">FILMOGRAPHIE</a></p>
					</div>
					<div class=\"menu_tab\">
	...
	//sniff... pas de champ pour dans la bdd :''(
	//a compléter si du temps il reste !
	function load_personnalite_biography($perso)
	{
		$string="</div>";
		echo $string;
	}
