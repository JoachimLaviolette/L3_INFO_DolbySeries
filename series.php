...
if(isset($_SESSION['theme']))
{
	if($_SESSION['theme']=="Rouge")
		echo "<link href=\"styles/series_css.css\" rel=\"stylesheet\" type=\"text/css\"/>";
	else if($_SESSION['theme']=="Bleu")
		echo "<link href=\"styles/series_css_blue.css\" rel=\"stylesheet\" type=\"text/css\"/>";
	else
		echo "<link href=\"styles/series_css_green.css\" rel=\"stylesheet\" type=\"text/css\"/>";
}
else
	echo "<link href=\"styles/series_css.css\" rel=\"stylesheet\" type=\"text/css\"/>"; 
	...
	<body>
		<main>
			...
			<div id="main">
				...
				<div id="main_content">
					<p>Rechercher une série :</p>
					<div id="series_search_bar">
						<form method="get" action="/recherche/recherche_serie.php">
							<input type="text" id="series_search_input" name="series_search_bar" placeholder="Entrez le nom d'une série (ex: Teen Wolf)" size="50" maxlength="50" onkeyup="propositions_series()"><button type="submit" id="search_button">RECHERCHER UNE SERIE</button> 
							<div id="list_of_series">
								<ul></ul>
							</div>			    
						</form>
					</div>
